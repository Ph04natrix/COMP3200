...
\appendix
% TC: ignore
\chapter{Project Brief} \label{appendix::project_brief}
\include{Appendix/projectbrief}
...
\chapter{Risk Analysis}%todo update it
\include{Appendix/riskanalysis}

%\chapter{Echo Nest Attribute Documentation}
%\include{Appendix/EchoNestAnalyzeDocumentation.pdf}
